...
class WANTxn extends PureComponent {
    ...
    return (
      <div className="txn-detail txn-eth">
        ...
        <div className="amount">
          ...
          <span className="value">{txnDetail.value / Math.pow(10, 18)} WAN</span>
        </div>
        ...
        <div className="gas-price">
          ...
          <span className="value">{txnDetail.gasPrice / Math.pow(10, 9)} Gwin</span>
        </div>
        <div className="fee">
          <span className="label">Fee:</span>
          <span className="value">{txnDetail.fee / Math.pow(10, 18)} WAN</span>
        </div>
        <div className="time">
          <span className="label">
            Included In Block:&nbsp; 
...
export default connectSettings(mapStateToProps, {})(WANTxn);